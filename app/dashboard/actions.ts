...
export async function createLinkAction(
  ...
  const shortCode = result.data.shortCode || generateShortCode(result.data.originalUrl);

  try {
    await createLink({ clerkUserId: userId, shortCode, originalUrl: result.data.originalUrl });
